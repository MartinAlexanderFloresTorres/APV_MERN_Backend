...
const emailRegistro = async (datos) => {
  ...
  <div style="text-align: center; margin: 20px 0 30px;"><span style="font-weight: bold; color: #4f46e5; font-size: 30px; margin-left: 10px;">APV - Administrador de Pacientes de Veterinaria</span></div>
  <p style="color: #757575; font-family: 'Open Sans', Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; letter-spacing: normal;">Hola ${nombre} comprueba tu cuenta en Administrador de Pacientes de Veterinaria,</p>
  ...
  <p style="font-style: italic; margin-bottom: 0;">Copyright &copy; 2022 Administrador de Pacientes de Veterinaria, All rights reserved.</p>
  ...
  const msg = {
    ...
    subject: "Compruebe su cuenta en Administrador de Pacientes de Veterinaria",
    text: "Administrador de Pacientes de Veterinaria",
    html: htmlConfirmar,
  };
  sgMail
    .send(msg)
...
const emailOlvidePassword = async (data) => {
  ...
  <div style="max-width: 600px; margin: auto;">
  <div style="background: white; padding: 15px 30px 25px 30px; border-radius: 5px;">
  <div style="text-align: center; margin: 20px 0 30px;"><span style="font-weight: bold; color: #4f46e5; font-size: 30px; margin-left: 10px;">Restablecer password en Administrador de Pacientes de Veterinaria</span></div>
  ...
  <p style="color: #757575; font-family: 'Open Sans', Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; letter-spacing: normal;">Has solicitado restablecer tu password en Administrador de Pacientes de Veterinaria</p>
...
`;
  ...
  const msg = {
    to: email,
    from: "martinflorestorres21@gmail.com",
    subject: "Restablecer password - Administrador de Pacientes de Veterinaria.",
    text: "Administrador de Pacientes de Veterinaria",
